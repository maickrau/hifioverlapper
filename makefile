...
_DEPS = MatchIndex.h MinimizerIterator.h ReadStorage.h KmerCorrector.h TwobitString.h
DEPS = $(patsubst %, $(SRCDIR)/%, $(_DEPS))

_OBJ = MatchIndex.o MinimizerIterator.o ReadStorage.o KmerCorrector.o TwobitString.o
